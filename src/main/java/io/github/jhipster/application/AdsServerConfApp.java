...
public class AdsServerConfApp {

    private static final Logger log = LoggerFactory.getLogger(AdsServerConfApp.class);

    private final Environment env;

    public AdsServerConfApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes adsServerConf.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(AdsServerConfApp.class);
